...
| [Question 3: Design a Key-Value Store](examples/question-3-design-a-key-value-store.md) | IC6/IC7 design covering sharding, quorum consistency, hot-key mitigation, and multi-region DR |
